...
import static be.kuleuven.pylos.player.student.StudentPlayerNegaMax.simulator;

public class StudentPlayerNegaMax extends PylosPlayer {
    public static PylosGameSimulator simulator;
    public static int MAX_DEPTH = 4;
    public static int PRM_DRIE,PRM_REMOVE;

    public StudentPlayerNegaMax(Integer drie, Integer remove){
        PRM_DRIE = drie;
        PRM_REMOVE = remove;
    }
